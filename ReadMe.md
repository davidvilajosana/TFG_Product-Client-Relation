...
1. `analisi_dades.ipynb`
2. `productes.ipynb`
3. `clients.ipynb`
4. `coclustering.ipynb`
5. `anex.ipynb`
...
- Es generen regles d'associació a través del algorisme Apriori
- Es generen agrupacions de productes segons característiques com la quantitat venuda, preu mitjà i temporalitat a través del clustering
...
- S’utilitza la matriu de client-producte
